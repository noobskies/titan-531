...
import { findGymsNearby } from '../services/geminiService';
import { MapPin, Navigation, Star, Loader, AlertTriangle } from 'lucide-react';
      ...
      {results && (
        <div className="space-y-4 animate-in slide-in-from-bottom-4">
           <div className="bg-slate-900/50 p-4 rounded-xl border border-slate-800 text-sm text-slate-300 leading-relaxed">
               {/* Render the AI Summary text, stripping out markdown bolding for cleaner look if needed, or just render as is */}
               {results.text}
           </div>
