...
import { Upload, Video, Loader, CheckCircle, AlertTriangle, PlayCircle } from 'lucide-react';
...
export const FormCheck: React.FC = () => {
  ...
  const handleFileSelect = (e: React.ChangeEvent<HTMLInputElement>) => {
    if (e.target.files && e.target.files[0]) {
      ...
      // Basic validation: limit to 20MB for demo purposes
    ...
    <div className="p-4 bg-card rounded-xl border border-slate-800 shadow-xl h-full overflow-y-auto">
        ...
        <div className="space-y-4">
            ...
            <div 
                ...
                className="border-2 border-dashed border-slate-700 rounded-xl p-6 text-center cursor-pointer hover:bg-slate-800/50 transition-colors"
            >
                {mediaFile ? (
